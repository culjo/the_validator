...
void main() {
  ...
  test("Check if value is required", () {
    ...
    expect(Validator.isRequired("  ", allowEmptySpaces: false),
        false); // Todo: Should we make empty string acceptable
  ...
  group("Password Strenght", () {
    test("Check if password is Strong enough", () {
      ...
      expect(Validator.isPassword("qwerty", shouldContainCapitalLetter: true),
          false);
      expect(Validator.isPassword("Qwerty", shouldContainCapitalLetter: true),
          true);
      expect(Validator.isPassword("qwerty1", shouldContainNumber: true), true);
      expect(Validator.isPassword("qwerty1%", shouldContainSpecialChars: true),
          true);
      expect(
          Validator.isPassword("Qwerty1%",
              shouldContainSpecialChars: true,
              shouldContainCapitalLetter: true,
              shouldContainNumber: true),
          true);
      expect(
          Validator.isPassword("Qwertyuiop1%",
              minLength: 10,
              shouldContainSpecialChars: true,
              shouldContainCapitalLetter: true,
              shouldContainNumber: true),
          true);
      expect(
          Validator.isPassword("Qwerty100#",
              maxLength: 10,
              shouldContainSpecialChars: true,
              shouldContainCapitalLetter: true,
              shouldContainNumber: true),
      ...
      expect(
          Validator.isPassword("Qwerty100#",
              ...
              shouldContainSpecialChars: true,
              shouldContainCapitalLetter: true,
              shouldContainNumber: true, isSpecialCharsPresent: (bool present) {
            print("isSpecialCharsPresent : $present");
          }),
          true);

      expect(Validator.isPassword("QWeRTY#", shouldContainSmallLetter: true),
          true);
    });
